...
public class MainActivity extends AppCompatActivity {
    ...
    public void login(View view) {
        ...
        if (Login.checkLogin(username, pw)) {
            ...
            SectionsPagerAdapter sectionsPagerAdapter = new SectionsPagerAdapter(currentUserID, getSupportFragmentManager());
            ...
            infoBtn.setOnClickListener(view1 -> Snackbar.make(view1, "The Recommendation generated by analyzing your spending pattern!", Snackbar.LENGTH_LONG)
